class OfficersController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @officer.update(officer_params)
        format.html { redirect_to @officer, notice: "Officer was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to officers_path, notice: "Officer was successfully destroyed.", status: :see_other }
  ...
  private
    ...
    def officer_params
      params.expect(officer: [ :badge_number, :first_name, :last_name, :rank, :assignments ])
    end
end
